...
TEMPERATUR=$($SNMPGET .1.3.6.1.4.1.21796.3.3.3.1.6.1 |awk -F : '{print $4/10}')
HUMIDITY=$($SNMPGET .1.3.6.1.4.1.21796.3.3.3.1.6.2 |awk -F : '{print $4/10}')
DOOR=$($SNMPGET .1.3.6.1.4.1.21796.3.3.1.1.2.1 |awk -F : '{print $4}')
echo "TEMP: $TEMPERATUR, HUM: $HUMIDITY, DOOR: $DOOR"
