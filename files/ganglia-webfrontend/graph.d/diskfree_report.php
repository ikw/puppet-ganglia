...
/* this is just the cpu_report (from revision r920) as an example, but with extra comments */
    ...
    // Context is not "host"
	    ...
	    $series_a = array(
			    "DEF:'total_free'=$rrd_dir/disk_free.rrd:sum:AVERAGE",
			    "VDEF:intercept=total_free,LSLINT",
			    "VDEF:slope=total_free,LSLSLOPE",
			    "VDEF:correlation=total_free,LSLCORREL",
			    "CDEF:free_trend=total_free,POP,intercept,COUNT,slope,*,+",
			    "AREA:total_free#009900:'Free Disk space '",
			    "GPRINT:total_free:AVERAGE:'%6.2lf%s\l'",
			    "LINE2:free_trend#0000FF:'Current usage trend'",
			    "GPRINT:correlation:'Correlation is %1.2lf\l'",
			    );
